...
export default function PorQueElegirnos({ razones }: PorQueElegirnosProps) {
  return (
            ...
            >
              <div className="relative mb-6">
                ...
                <div className="relative w-16 h-16 bg-gradient-to-br from-lime-300/20 to-lime-300/5 rounded-2xl flex items-center justify-center">
                  <FaCheckCircle className="w-8 h-8 text-lime-300" />
                </div>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-white">{razon.title}</h3>
